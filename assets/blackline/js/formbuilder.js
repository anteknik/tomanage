...
(function() {
  Formbuilder.registerField('section_break', {
    ...
    addButton: "<span class='symbol'><span class='icon-white icon-minus'></span></span> Section Break"
  });
...
'" title="Add Option"><i class=\'icon-white icon-plus\'></i></a>\n  <a class="js-remove-option ' +
((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
'" title="Remove Option"><i class=\'icon-white icon-minus\'></i></a>\n</div>\n\n';
...
((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
'" title="Duplicate Field"><i class=\'icon-white icon-plus\'></i></a>\n  <a class="js-clear ' +
((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
'" title="Remove Field"><i class=\'icon-white icon-minus\'></i></a>\n</div>';
