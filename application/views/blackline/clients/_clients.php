...
<div class="modal-content">
    <div class="modal-inner">
        ...
        <p>
            ...
            <input id="firstname" type="text" name="firstname" class="required span5" value="<?php if (isset($client)) {
        ...
        <p>
            ...
            <input id="lastname" type="text" name="lastname" class="required span5" value="<?php if (isset($client)) {
        ...
        <p>
            ...
            <input id="email" type="text" name="email" class="required email span5" value="<?php if (isset($client)) {
                echo $client->email;
            } ?>"/>
        </p>
        ...
        <p>
            ...
            <input id="phone" type="text" name="phone" class="span5" value="<?php if (isset($client)) {
                echo $client->phone;
            } ?>"/>
        </p>
        ...
        <p>
            ...
            <input id="mobile" type="text" name="mobile" class="span5" value="<?php if (isset($client)) {
                echo $client->mobile;
            } ?>"/>
        </p>
        ...
        <p>
            ...
            <input id="address" type="text" name="address" class="span5" value="<?php if (isset($client)) {
                echo $client->address;
            } ?>"/>
        </p>
        ...
        <p>
            ...
            <input id="zipcode" type="text" name="zipcode" class="span5" value="<?php if (isset($client)) {
                echo $client->zipcode;
            } ?>"/>
        </p>
        ...
        <p>
            ...
            <input id="city" type="text" name="city" class="span5" value="<?php if (isset($client)) {
                echo $client->city;
            } ?>"/>
        </p>
        ...
        <p>
            ...
            <input id="password" type="password" name="password" class="required span5"
        ...
        <ul class="accesslist">
            <?php foreach ($modules as $key => $value) { ?>
                <li><input type="checkbox" class="cb" id="r_<?= $value->link; ?>" name="access[]"
                           value="<?= $value->id; ?>" <?php if (in_array($value->id, $access)) {
                        echo 'checked="checked"';
                    } ?>> <label
                        for="r_<?= $value->link; ?>"><?= $this->lang->line('application_' . $value->link); ?></label>
                </li>
            <?php } ?>
        </ul>
        </p>
