...
<div class="modal-content">
    <div class="modal-inner">
        ...
        <p>
            ...
            <input id="reference" type="text" name="reference" class="required span5"
                   value="<?php if (isset($company)) {
        ...
        <p>
            <label
                for="name"><?= $this->lang->line('application_company'); ?> <?= $this->lang->line('application_name'); ?>
                *</label>
            <input id="name" type="text" name="name" class="required span5" value="<?php if (isset($company)) {
                echo $company->name;
            } ?>"/>
        </p>
        ...
        <p>
            ...
            <input id="website" type="text" name="website" class="required span5" value="<?php if (isset($company)) {
        ...
        <p>
            ...
            <input id="phone" type="text" name="phone" class="span5" value="<?php if (isset($company)) {
                echo $company->phone;
            } ?>"/>
        </p>
        ...
        <p>
            ...
            <input id="mobile" type="text" name="mobile" class="span5" value="<?php if (isset($company)) {
                echo $company->mobile;
            } ?>"/>
        </p>
        ...
        <p>
            ...
            <input id="address" type="text" name="address" class="span5" value="<?php if (isset($company)) {
        ...
        <p>
            ...
            <input id="zipcode" type="text" name="zipcode" class="span5" value="<?php if (isset($company)) {
        ...
        <p>
            ...
            <input id="city" type="text" name="city" class="span5" value="<?php if (isset($company)) {
                echo $company->city;
            } ?>"/>
        </p>
        ...
        <p>
            ...
            <input id="country" type="text" name="country" class="span5" value="<?php if (isset($company)) {
