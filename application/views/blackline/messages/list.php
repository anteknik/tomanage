    ...
    <?php if ($message) {
        foreach ($message as $value):
            ...
            <li class="<?= $value->status; ?>">
                <a href="<?= base_url() ?>messages/view/<?= $value->id; ?>" id="listmessage<?= $value->id; ?>"
                   class="ajax">
...
<div style="height:50px">
    <div class="dataTables_paginate paging_two_button">
        <?php if ($message_list_page_prev >= 0) { ?>
            <a href="<?= base_url() ?>messages/messagelist/<?= $message_list_page_prev; ?><?php if (isset($deleted)) {
                echo $deleted;
            } ?>"
        ...
        if ($message_list_page_next < $message_rows) { ?><a
            href="<?= base_url() ?>messages/messagelist/<?= $message_list_page_next; ?><?php if (isset($deleted)) {
                echo $deleted;
            } ?>"
