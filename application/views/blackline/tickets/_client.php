...
<div class="modal-content">
    <div class="modal-inner">
        ...
        <p>
            ...
            <input id="subject" type="text" name="subject" class="required span5"
                   value="<?= $this->lang->line('application_notification_ticket_assign_subject'); ?>"/>
        </p>
        ...
        <ul class="accesslist" style="margin: 2px;">
            <li><input type="checkbox" class="cb" id="r_notify" name="notify" value="yes"> <label
                    for="r_notify"><?= $this->lang->line('application_notify_client'); ?></label></li>
        </ul>
