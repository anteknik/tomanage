...
<div class="modal-content">
    <div class="modal-inner">
        ...
        <p>
            ...
            endforeach;
            if (isset($ticket) && isset($ticket->type->id)) {
                $type = $ticket->type->id;
            } else {
                $type = "";
            }
        ...
        <p>
            ...
            foreach ($queues as $value):
                $options[$value->id] = $value->name;
            endforeach;
            if (isset($ticket) && isset($ticket->queue->id)) {
        ...
        <p>
            ...
            endforeach;
            if (isset($ticket) && isset($ticket->company->id)) {
        ...
        <p>
            ...
            foreach ($users as $value):
                $options[$value->id] = $value->firstname . ' ' . $value->lastname;
            endforeach;
            if (isset($ticket) && isset($ticket->user->id)) {
                $user = $ticket->user->id;
            } else {
                $user = "";
            }
        ...
        <p>
            ...
            <input id="subject" type="text" name="subject" class="required span5" value="<?php if (isset($ticket)) {
                echo $ticket->subject;
            } ?>"/>
        </p>
        ...
        <ul class="accesslist" style="margin: 2px;">
            <li><input type="checkbox" class="cb" id="r_notify" name="notify_agent" value="yes"> <label
                    for="r_notify"><?= $this->lang->line('application_notify_agent'); ?></label></li>
        </ul>
