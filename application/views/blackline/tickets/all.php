<div id="main">
    <div id="options">
        <a href="<?= base_url() ?>tickets/create" class="btn" data-toggle="modal"><i
                class="icon-plus-sign"></i> <?= $this->lang->line('application_create_new_ticket'); ?></a>
    ...
    <table class="data-sorting" id="tickets" rel="<?= base_url() ?>" cellspacing="0" cellpadding="0">
        ...
        <th class="hidden-phone no_sort" style="width:5px; padding-right: 5px;"><i class="icon icon-star-empty"></i>
        </th>
        ...
        <?php foreach ($ticket as $value): ?>
            ...
            <tr id="<?= $value->id; ?>">
                ...
                <td class="hidden-phone"
                    style="width:15px"><?php if ($value->updated == "1" && $user_id == $this->user->id) { ?><i
                        class="icon icon-star"></i><?php } else { ?> <i class="icon icon-star-empty"
                                                                        style="opacity: 0.2;"></i><?php } ?></td>
                <td><?= $value->subject; ?></td>
                <?php $lable = FALSE;
                if ($value->status == "new") {
                ...
                <td><span
                        class="label <?php echo $lable; ?>"><?= $this->lang->line('application_ticket_status_' . $value->status); ?></span>
                </td>
                <td><?php if (!isset($value->company->name)) {
                ...
                <td class="hidden-phone"><?php if (!isset($value->user->firstname)) {
