...
<div class="modal-content">
    <div class="modal-inner">
        ...
        <input id="progress" type="hidden" name="progress" value="<?php if (isset($project)) {
        ...
        <p>
            ...
            endforeach;
            if (isset($project) && isset($project->company->id)) {
        ...
        <p>
            <label for="progress"><?= $this->lang->line('application_progress'); ?>: <span
                    id="pvalue"><?php if (isset($project)) {
                        echo $project->progress;
                    } else {
                        echo "0";
                    } ?> %</span></label>
        ...
        <div class="switch switch-mini" data-on-label="<i class='icon-ok icon-white'></i>"
            ...
            <input name="progress_calc" type="checkbox"
                   value="1" <?php if (isset($project) && $project->progress_calc == "1") { ?> checked="checked" <?php } ?>>
        </div>
        </p>
        <p>
            <label for="name"><?= $this->lang->line('application_name'); ?> *</label>
            <input id="name" type="text" name="name" class="required span5" value="<?php if (isset($project)) {
                echo $project->name;
            } ?>"/>
        </p>
        ...
        <p>
            ...
            <input id="start" type="text" name="start" class="required datepicker span5"
        ...
        <p>
            ...
            <input id="end" type="text" name="end" class="required datepicker span5" value="<?php if (isset($project)) {
                echo $project->end;
            } ?>"/>
        </p>
        ...
        <p>
            ...
            <input id="category" type="text" name="category" class="span5" value="<?php if (isset($project)) {
        ...
        <p>
            ...
            <input id="phases" type="text" name="phases" class="required span5" value="<?php if (isset($project)) {
                echo $project->phases;
            } else {
                echo "Planning, Developing, Testing";
            } ?>"/>
        </p>

        <p>
            <label for="description"><?= $this->lang->line('application_description'); ?></label>
            <textarea id="description" name="description" class="span5" rows="4"><?php if (isset($project)) {
