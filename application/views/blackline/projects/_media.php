...
<div class="modal-content">
    <div class="modal-inner">
        <p>
            ...
            <input id="name" type="text" name="name" class="required span5" value="<?php if (isset($media)) {
                echo $media->name;
            } ?>"/>
        </p>
        ...
        <p>
            ...
            <input id="description" type="text" name="description" class="span5" value="<?php if (isset($media)) {
...
<p>
      ...
      <div class="dummyfile">
         <div class="input-append">
              <input id="filename" type="text" class="input span4 required" name="file-name">
...
<?php } ?>
    ...
    <div class="modal-footer">
        <input type="submit" id="send" name="send" class="btn btn-primary btn-loader"
