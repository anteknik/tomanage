<div id="main">
                ...
                <ul class="details span6">
                    ...
                    <li class="<?= $subscription->status; ?>"><span><?= $this->lang->line('application_status'); ?>
                        ...
                        <a class="label <?php if ($subscription->status == 'Active') {
                            ...
                            } ?></a>            <?php if ($subscription->subscribed != "0") { ?>  <a
                ...
                <ul class="details span6">
                    <?php if (isset($subscription->company->name)) { ?>
                        ...
                        <li><span><?= $this->lang->line('application_email'); ?>
                                :</span> <?php if (isset($subscription->company->client->email)) { ?> <?= $subscription->company->client->email; ?> <?php } else {
                                echo "-";
                            } ?></li>
    ...
    <div class="row">
        <div class="table_head"><h6><i
                    class="icon-list-alt"></i><?= $this->lang->line('application_subscription_items'); ?></h6></div>
        <table id="items" rel="<?= base_url() ?>" cellspacing="0" cellpadding="0">
            ...
            <?php if ($core_settings->tax != 0) { ?>
                <tr>
                    <td colspan="4" align="right"><?= $this->lang->line('application_tax'); ?>
                        (<?= $core_settings->tax ?>%)
                    </td>
                    <td><?= $tax ?></td>
                </tr>
    ...
    <?php if ($core_settings->paypal == "1" && $sum != "0.00" && $subscription->subscribed == "0") { ?><br/>
        <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
            ...
            <input type="hidden" name="return"
                   value="<?= base_url() ?>csubscriptions/success/<?= $subscription->id; ?>">
