...
<div class="modal-content">
    <div class="modal-inner">
        ...
        <p>
            ...
            <input id="reference" type="text" name="reference" class="span5" value="<?php if (isset($subscription)) {
        ...
        <p>
            ...
            <input id="issue_date" type="text" name="issue_date" class="required datepicker span5"
                   value="<?php if (isset($subscription)) {
        ...
        <p>
            ...
            <input id="end_date" type="text" name="end_date" class="required datepicker span5"
                   value="<?php if (isset($subscription)) {
        ...
        <p>
            ...
            <input id="currency" type="text" name="currency" class="required span1"
                   value="<?php if (isset($subscription)) {
        ...
        <p>
            ...
            <input class="span1" name="discount" id="appendedInput" type="text" value="<?php if (isset($subscription)) {
        ...
        <p>
            ...
            <textarea id="terms" name="terms" class="textarea required span5"
                      style="height:100px"><?php if (isset($subscription)) {
