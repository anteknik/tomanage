...
<div class="modal-content">
    <div class="modal-inner">
        ...
        if (isset($subscription_has_items)) { ?>
            ...
            <input id="subscription_id" type="hidden" name="subscription_id"
                   value="<?= $subscription_has_items->subscription_id; ?>"/>
        <?php } else { ?>
            <p id="item-selector">
                ...
                <a class="btn tt additem" style="margin-left:6px; height: 18px !important;"
                   titel="<?= $this->lang->line('application_custom_item'); ?>"><i class="icon-plus-sign"></i></a>
            </p>
        ...
        <p>
            ...
            <input id="amount" type="text" name="amount" class="required span2 number"
                   value="<?php if (isset($subscription_has_items)) {
                       echo $subscription_has_items->amount;
                   } else {
                       echo '1';
                   } ?>"/>
        </p>
        ...
        <p>
            ...
            <textarea id="description" class="span5" name="description"><?php if (isset($subscription_has_items)) {
                    echo $subscription_has_items->description;
                } ?></textarea>
        </p>
