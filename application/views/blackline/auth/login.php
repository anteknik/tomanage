<div class="login">
    <div class="center"><img src="<?= base_url() ?><?= $core_settings->logo; ?>" alt="<?= $core_settings->company; ?>"/>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" class="span3" name="username" id="username"
                   placeholder="<?= $this->lang->line('application_username'); ?>">
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            <input type="password" class="span3" name="password" id="password"
                   placeholder="<?= $this->lang->line('application_password'); ?>">
        </div>
    </div>
    <div class="controls">
        <button type="submit" class="btn btn-primary"><?= $this->lang->line('application_login'); ?></button>
        <a href="<?= site_url("forgotpass"); ?>"
           class="pull-right forgotpass"><?= $this->lang->line('application_forgot_password'); ?></a>
    </div>
    <?= form_close() ?>
