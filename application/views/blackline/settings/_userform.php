...
<div class="modal-content">
    <div class="modal-inner">
        <p>
            ...
            <input id="username" type="text" name="username" class="required span5" value="<?php if (isset($user)) {
                echo $user->username;
            } ?>"/>
        </p>
        ...
        <p>
            ...
            <input id="firstname" type="text" name="firstname" class="required span5" value="<?php if (isset($user)) {
                echo $user->firstname;
            } ?>"/>
        </p>
        ...
        <p>
            ...
            <input id="lastname" type="text" name="lastname" class="required span5" value="<?php if (isset($user)) {
                echo $user->lastname;
            } ?>"/>
        </p>
        ...
        <p>
            ...
            <input id="email" type="text" name="email" class="required email span5" value="<?php if (isset($user)) {
                echo $user->email;
            } ?>"/>
        </p>
        ...
        <p>
            ...
            <input id="password" type="password" name="password" class="span5 <?php if (!isset($user)) {
                echo 'required';
            } ?>" minlength="6"/>
        </p>
        ...
        <?php if (!isset($agent)) { ?>
            <p>
                ...
                <input id="title" type="text" name="title" class="required span5" value="<?php if (isset($user)) {
                    echo $user->title;
                } ?>"/>
            </p>
            <p>
