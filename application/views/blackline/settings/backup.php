<div id="main">
    ...
    <div class="table_head"><h6><i class="icon-download"></i><?= $this->lang->line('application_database_backups'); ?>
        </h6> <a href="mysql_restore" class="btn btn-mini pull-right" data-toggle="modal"><i
                class="icon icon-upload"></i> <?= $this->lang->line('application_restore_database'); ?></a><a
            href="<?= base_url() ?>settings/mysql_backup" class="btn btn-mini pull-right"><i
                class="icon-download"></i> <?= $this->lang->line('application_backup_database'); ?></a></div>
                ...
                <tr>
                    ...
                    <td class="option" style="width:125px">
                        <a class="btn btn-mini"
                           href="mysql_download/<?= $file ?>"><?= $this->lang->line('application_download'); ?></a>
                    </td>
                </tr>
