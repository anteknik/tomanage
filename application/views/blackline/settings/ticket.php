<div id="main">
    ...
    <div class="table_head">
        <h6><?= $this->lang->line('application_email'); ?> <?= $this->lang->line('application_settings'); ?></h6></div>
    <?php
    ...
    <table id="settings" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td><?= $this->lang->line('application_postmaster_active'); ?> <a class="cursor po pull-right" rel="popover"
                                                                              data-content="<?= $this->lang->line('application_postmaster_help'); ?>"
                                                                              data-original-title="<?= $this->lang->line('application_ticket'); ?>"><i
                        class="fam-information"></i></td>
            <td>
                <div class="switch switch-mini" data-on-label="<i class='icon-ok icon-white'></i>"
                     data-off-label="<i class='icon-remove'></i>">
                    <input name="ticket_config_active" type="checkbox"
                           value="1" <?php if ($settings->ticket_config_active == "1") { ?> checked="checked" <?php } ?>>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="switch switch-mini" data-on-label="<?= $this->lang->line('application_imap'); ?>"
                     data-off-label="<?= $this->lang->line('application_pop'); ?>">
                    <input name="ticket_config_imap" type="checkbox"
                           value="1" <?php if ($settings->ticket_config_imap == "1") { ?> checked="checked" <?php } ?>>
                </div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <div class="switch switch-mini" data-on-label="<i class='icon-ok icon-white'></i>"
                     data-off-label="<i class='icon-remove'></i>">
                    <input name="ticket_config_ssl" type="checkbox"
                           value="1" <?php if ($settings->ticket_config_ssl == "1") { ?> checked="checked" <?php } ?>>
                </div>
            </td>
        </tr>

        <tr>
            <td><?= $this->lang->line('application_delete_from_mailbox'); ?> <a class="cursor po pull-right"
                                                                                rel="popover"
                                                                                data-content="<?= $this->lang->line('application_delete_from_mailbox_help'); ?>"
                                                                                data-original-title="<?= $this->lang->line('application_delete'); ?>"><i
                        class="fam-information"></i></td>
            <td>
                <div class="switch switch-mini" data-on-label="<i class='icon-ok icon-white'></i>"
                     data-off-label="<i class='icon-remove'></i>">
                    <input name="ticket_config_delete" type="checkbox"
                           value="1" <?php if ($settings->ticket_config_delete == "1") { ?> checked="checked" <?php } ?>>
                </div>
            </td>
        </tr>
        ...
        <tr>
            <td><?= $this->lang->line('application_imap_search'); ?> <a class="cursor po pull-right" rel="popover"
                                                                        data-content="<?= $this->lang->line('application_imap_search_help'); ?>"
                                                                        data-original-title="<?= $this->lang->line('application_imap_search'); ?>"><i
                        class="fam-information"></i></td>
            <td><input type="text" name="ticket_config_search" value="<?= $settings->ticket_config_search; ?>"></td>
        </tr>

        <tr>
            <td><?= $this->lang->line('application_postmaster_address'); ?>  <a class="cursor po pull-right"
                                                                                rel="popover"
                                                                                data-content="<?= $this->lang->line('application_postmaster_help'); ?>"
                                                                                data-original-title="<?= $this->lang->line('application_postmaster_address'); ?>"><i
                        class="fam-information"></i></td>
            <td>wget <?= base_url() ?>postmaster -O /dev/null</td>
        </tr>
        <tr>
            <td><?= $this->lang->line('application_last_postmaster_run'); ?></td>
            <td><?php if (!empty($settings->ticket_config_timestamp)) {
        ...
        <tr>
            <td class="bottom" colspan="2">
                ...
                <a href="<?= base_url() ?>settings/testpostmaster" class="btn"
                   data-toggle="modal"><?= $this->lang->line('application_postmaster_test'); ?></a>
            </td>
        </tr>
    </table>
    ...
    <div class="table_head">
        <h6><?= $this->lang->line('application_ticket'); ?> <?= $this->lang->line('application_settings'); ?></h6></div>
    ...
    <div class="row">
        <div class="span6 nosearch">
            <div class="table_head"><h6><i class="icon-tag"></i><?= $this->lang->line('application_types'); ?></h6><a
                    href="<?= base_url() ?>settings/ticket_type" class="btn btn-mini pull-right" data-toggle="modal"><i
                        class="icon-plus"></i> <?= $this->lang->line('application_add_type'); ?></a></div>
                    ...
                    <tr id="t<?= $value->id; ?>">
                        ...
                        <td class="option btn-group">
                            <a class="btn btn-mini po" rel="popover" data-placement="left"
                               data-content="<a class='btn btn-danger po-delete ajax-silent' href='<?= base_url() ?>settings/ticket_type/<?= $value->id; ?>/delete'><?= $this->lang->line('application_yes_im_sure'); ?></a> <button class='btn po-close'><?= $this->lang->line('application_no'); ?></button> <input type='hidden' name='td-id' class='id' value='t<?= $value->id; ?>'>"
                               data-original-title="<b><?= $this->lang->line('application_really_delete'); ?></b>"><i
                                    class="icon-trash"></i></a>
                            <a href="<?= base_url() ?>settings/ticket_type/<?= $value->id; ?>" class="btn btn-mini"
        ...
        <div class="span6 nosearch">
            <div class="table_head"><h6><i class="icon-tag"></i><?= $this->lang->line('application_queues'); ?></h6><a
                    href="<?= base_url() ?>settings/ticket_queue" class="btn btn-mini pull-right" data-toggle="modal"><i
                        class="icon-plus"></i> <?= $this->lang->line('application_add_queue'); ?></a></div>
            <table class="data" id="queues" cellspacing="0" cellpadding="0">
                ...
                <?php foreach ($queues as $value): ?>
                    ...
                    <tr id="q<?= $value->id; ?>">
                        ...
                        <td class="option btn-group">
                            <a class="btn btn-mini po" rel="popover" data-placement="left"
                               data-content="<a class='btn btn-danger po-delete ajax-silent' href='<?= base_url() ?>settings/ticket_queue/<?= $value->id; ?>/delete'><?= $this->lang->line('application_yes_im_sure'); ?></a> <button class='btn po-close'><?= $this->lang->line('application_no'); ?></button> <input type='hidden' name='td-id' class='id' value='q<?= $value->id; ?>'>"
                               data-original-title="<b><?= $this->lang->line('application_really_delete'); ?></b>"><i
                                    class="icon-trash"></i></a>
                            <a href="<?= base_url() ?>settings/ticket_queue/<?= $value->id; ?>" class="btn btn-mini"
                               data-toggle="modal"><i class="icon-edit"></i></a>
                        </td>
                    </tr>
