<div id="main">
    ...
    <div class="table_head">
        <h6><?= $this->lang->line('application_paypal'); ?> <?= $this->lang->line('application_settings'); ?></h6></div>
    <?php
    ...
    <table id="settings" cellspacing="0" cellpadding="0">
            ...
            <td>
                <div class="switch switch-mini" data-on-label="<i class='icon-ok icon-white'></i>"
                    ...
                    <input name="paypal" type="checkbox"
                           value="1" <?php if ($settings->paypal == "1") { ?> checked="checked" <?php } ?>>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <select name="paypal_currency" style="width:100px">
                    <?php if ($settings->paypal_currency != "") { ?>
                        <option value="<?= $settings->paypal_currency; ?>"
                                selected=""><?= $settings->paypal_currency; ?></option><?php } ?>
        ...
        <tr>
            <td><?= $this->lang->line('application_paypal_ipn_address'); ?> <a class="cursor po pull-right"
                                                                               rel="popover"
                                                                               data-content="<?= $this->lang->line('application_paypal_ipn_help'); ?>"
                                                                               data-original-title="<?= $this->lang->line('application_paypal_ipn_address'); ?>"><i
