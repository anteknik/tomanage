...
<table id="settings" cellspacing="0" cellpadding="0">
    ...
    <tr>
        ...
        <td><input type="text" name="invoice_contact" class="required no-margin span6"
                   value="<?= $settings->invoice_contact; ?>"></td>
    </tr>
    <tr>
        <td><?= $this->lang->line('application_address'); ?></td>
        <td><input type="text" name="invoice_address" class="required no-margin span6"
                   value="<?= $settings->invoice_address; ?>"></td>
    </tr>
    <tr>
        <td><?= $this->lang->line('application_city'); ?></td>
        <td><input type="text" name="invoice_city" class="required no-margin span6"
                   value="<?= $settings->invoice_city; ?>"></td>
    </tr>
    <tr>
        <td><?= $this->lang->line('application_phone'); ?></td>
        <td><input type="text" name="invoice_tel" class="required no-margin span6"
                   value="<?= $settings->invoice_tel; ?>"></td>
    </tr>
    <tr>
    ...
    <tr>
        <td><?= $this->lang->line('application_domain'); ?> <a class="cursor po pull-right" rel="popover"
                                                               data-content="Full URL to your Freelance Cockpit installation. Including subfolder i.e. http://www.yoursite.com/FC/"
                                                               data-original-title="Domain URL"><i
    ...
    <tr>
        <td><?= $this->lang->line('application_logo'); ?> (max 200x200)<a class="cursor po pull-right" rel="popover"
                                                                          data-content="<div class='logo'><img src='<?= $core_settings->logo; ?>'></div>"
                                                                          data-original-title="<?= $this->lang->line('application_logo'); ?>"><i
                    class="fam-information"></i></a>
        </td>
        <td>
            ...
            <div class="dummyfile">
                <div class="input-append no-margin">
                    ...
                    <a id="fileselectbutton" rel="upload1"
                       class="btn"><?= $this->lang->line('application_select'); ?></a>
    ...
    <tr>
        <td><?= $this->lang->line('application_invoice'); ?> <?= $this->lang->line('application_logo'); ?>  (max
            200x200)<a class="cursor po pull-right" rel="popover"
                       data-content="<div class='logo' style='background:#FFFFFF'><img src='<?= $core_settings->invoice_logo; ?>'></div>"
                       data-original-title="<?= $this->lang->line('application_invoice'); ?> <?= $this->lang->line('application_logo'); ?>"><i
                    class="fam-information"></i></a>
        </td>
        <td>
    ...
    <tr>
        ...
        <td>
            <div class="input-append">
                <input class="number required  no-margin span1" name="tax" id="appendedInput" type="text"
                       value="<?= $settings->tax; ?>"><span class="add-on">%</span>
            </div>
        </td>
    </tr>
    <tr>
        <td><?= $this->lang->line('application_default_currency'); ?></td>
        <td><input type="text" name="currency" class="required no-margin span1" value="<?= $settings->currency; ?>">
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><textarea class="textarea required no-margin span12" name="invoice_terms"
                      rows="5"><?= $settings->invoice_terms; ?></textarea></td>
    </tr>
    <tr>
