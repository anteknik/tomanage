...
<div class="row">
    <div class="span12 marginbottom20">
        <div class="table_head"><h6><i class="icon-list"></i>Logs</h6><a href="<?= base_url() ?>settings/logs"
                                                                         class="btn btn-mini pull-right"><i
                    class="icon-refresh"></i> <?= $this->lang->line('application_refresh'); ?></a><a
                href="<?= base_url() ?>settings/logs/clear" class="btn btn-mini pull-right"><i
                    class="icon-trash"></i> <?= $this->lang->line('application_clear'); ?></a></div>
        <div class="subcont">
