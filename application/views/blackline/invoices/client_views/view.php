<div id="main">
    <div id="options">
        <a href="<?= base_url() ?>cinvoices/download/<?= $invoice->id; ?>" class="btn"><i
                class="icon-file"></i> <?= $this->lang->line('application_download_invoice'); ?></a>
                ...
                <ul class="details span6">
                    ...
                    <li class="<?= $invoice->status; ?>"><span><?= $this->lang->line('application_status'); ?>:</span>
                        <?php if ($invoice->status == "Paid") {
                            echo '<a class="label label-success">' . $this->lang->line('application_' . $invoice->status);
                        } else {
                            echo '<a class="label label-warning">' . $this->lang->line('application_open');
                        } ?>
                        </a>
                    </li>
                ...
                <ul class="details span6">
                    <?php if (isset($invoice->company->name)) { ?>
                        <li><span><?= $this->lang->line('application_company'); ?>:</span> <a
                                href="<?= base_url() ?>companies/view/<?= $invoice->company->id; ?>"
