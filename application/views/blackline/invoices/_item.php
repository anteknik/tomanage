    ...
    <div class="modal-inner">
        ...
        <p>
            ...
            <input id="amount" type="text" name="amount" class="required span2 number"
                   value="<?php if (isset($invoice_has_items)) {
                       echo $invoice_has_items->amount;
                   } else {
                       echo '1';
                   } ?>"/>
        </p>
        ...
        <p>
            ...
            <textarea id="description" class="span5" name="description"><?php if (isset($invoice_has_items)) {
                    echo $invoice_has_items->description;
                } ?></textarea>
        </p>
