<div id="main">
    <div id="options">
        <a href="<?= base_url() ?>invoices/create" class="btn" data-toggle="modal"><i
    ...
    <div class="table_head"><h6><i class="icon-list-alt"></i><?= $this->lang->line('application_invoices'); ?></h6>
    </div>
    <table class="data" id="invoices" rel="<?= base_url() ?>" cellspacing="0" cellpadding="0">
        ...
        <?php foreach ($invoices as $value): ?>
            ...
            <tr id="<?= $value->id; ?>">
                ...
                <td class="hidden-phone"><span class="label <?php if ($value->status == "Paid") {
                        echo 'label-success';
                    }
