...
<div class="modal-content">
    <div class="modal-inner">
        ...
        <p>
            ...
            <input id="reference" type="text" name="reference" class="span5" value="<?php if (isset($invoice)) {
        ...
        <p>
            ...
            <input id="due_date" type="text" name="due_date" class="required datepicker span5"
                   value="<?php if (isset($invoice)) {
        ...
        <p>
            ...
            <input id="currency" type="text" name="currency" class="required span1" value="<?php if (isset($invoice)) {
        ...
        <p>
            ...
            <input class="span1" name="discount" id="appendedInput" type="text" value="<?php if (isset($invoice)) {
        ...
        <p>
            ...
            <textarea id="terms" name="terms" class="textarea required span5"
                      style="height:100px"><?php if (isset($invoice)) {
                    echo $invoice->terms;
                } else {
